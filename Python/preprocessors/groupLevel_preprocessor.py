...
if __name__ == "__main__":
    ...
    usage = lambda: print("Usage: python groupLevel_preprocessor.py <input_dir>") or sys.exit(1)
        ...
        (lambda parquet_files: (
            ...
            (lambda group_df: (
                ...
                (lambda clean_df: (
                    ...
                    print(f"[Nextflow] Group-level preprocessing finished. Output: {get_output_filename(input_dir)}")
