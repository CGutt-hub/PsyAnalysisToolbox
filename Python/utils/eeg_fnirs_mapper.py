...
class EEGfNIRSMapper:
    """
    Selects EEG channels based on fNIRS ROI activity and a defined strategy.
    """
    ...
    def select_channels(self, eeg_info: mne.Info, fnirs_active_rois: List[str]) -> List[str]:
        ...
        self.logger.info(f"Final selected EEG channels using strategy '{self.strategy}': {final_selected_channels}")
        return final_selected_channels