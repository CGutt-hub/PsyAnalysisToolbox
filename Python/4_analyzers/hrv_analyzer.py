...
class HRVAnalyzer:
    ...
    def calculate_hrv_metrics_from_nni_file(self, nn_intervals_path, nni_column_name='NN_Interval_ms'):
        """
        ...
        Args:
            ...
            nni_column_name (str): Name of the column containing NN intervals in milliseconds.
        Returns:
        ...
        if nn_intervals_path is None or not os.path.exists(nn_intervals_path):
            ...
            hrv_metrics['hrv_rmssd_Overall'] = np.nan # Ensure key exists even on failure
            return hrv_metrics
